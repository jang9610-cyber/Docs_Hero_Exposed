...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const monstersData = {
    ...
    DarkElf: {
      name: "다크엘프 (DarkElf)",
      dept: "전략기획팀 브랜드 마케터",
      desc: "차가운 눈빛에 냉정하며, 업무 중심적인 존댓말과 영어식 마케팅 전문 은어를 사용하는 엘리트 마족 사원입니다. 매우 빈틈이 없고 완벽해 보이지만, 플레이어가 가치관이나 논리적 압박을 가해 스트레스가 100을 돌파하면 본성이 튀어나옵니다. 다크엘프의 탈을 쓴 인간 스파이(성직자/성녀)는 타인의 아픔을 지켜보지 못하는 본능을 숨기지 못하고, 상대의 상처를 걱정하거나 무의식적으로 힐러의 대사와 신성 주문을 외워 치료해주려 하는 버릇을 보여 검거됩니다."
    },
    Ghoul: {
      name: "구울 (Ghoul)",
      dept: "시설관리팀 단순 잡부",
